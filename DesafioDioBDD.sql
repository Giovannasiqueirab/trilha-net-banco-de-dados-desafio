...
/*
   Este script tem o propósito exclusivo de fins educacionais e práticos, seguindo as orientações fornecidas pelo professor
   no bootcamp .Net Developer. Ele visa consolidar os conhecimentos em SQL Server, conforme descrito no README do projeto.

   Objetivo: 
	Criar diversas consultas, com o objetivo de retornar os dados pedidos para o desafio.
*/
